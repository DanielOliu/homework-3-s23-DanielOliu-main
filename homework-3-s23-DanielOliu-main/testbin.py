...
data = np.loadtxt('homework-3-s23-DanielOliu-main/input.txt')
lo = min(data)
hi = max(data)


#print('Uncomment the first segment to verify the histogram you have generated, the normalized histogram you have generated, and the number of samples')
